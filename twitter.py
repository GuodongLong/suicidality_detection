...
def f_basic(data):
    ...
    features = {'title_words': num_title_words,
...
def f_liwc(class_type, subreddit):
    liwc_twitter = pd.read_csv('sample_2_liwc.csv'.format(class_type, subreddit))  # extracted features using LIWC
...
if __name__ == '__main__':
    class_type = 'imbalanced'  # class_type = 'imbalanced'
    subreddit = 'twitter'  # subreddit = 'twitter'
